...
"""
import argparse, os, h5py, time, vlc, signal, sys
...
def main():
	...
	argparser.add_argument('--delay', '-d', type=float, help='Delay of the Tap', default=0.12)
	argparser.add_argument('--optimize', '-z', type=bool, help='Optimize of the beats with MADMOM as reference', default=True)
	argparser.add_argument('--margin', '-m', type=float, help='Error Margin of the bpm between lib and user', default=0.5)
	argparser.add_argument('--annotation', '-a', type=str, help='Annotation for optimize if there is one')
