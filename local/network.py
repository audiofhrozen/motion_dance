...
class Network(chainer.Chain):
    def __init__(self, InitOpt):
        ...
        super(Network, self).__init__(
            conv1 = L.Convolution2D(1, 16, ksize=(33, 2), nobias=True),
            cvbn1 = L.BatchNormalization(16),
            conv2 = L.Convolution2D(16, 32, ksize=(33, 2), nobias=True),
            ...
            fc01 = L.Linear(units, dim),   
            #dec_lstm1 = L.LSTM(65, units),
            dec_lstm1 = L.LSTM(dim*2, units),
            dec_lstm2 = L.LSTM(units, units),
            dec_lstm3 = L.LSTM(units, units),
            out_signal = L.Linear(units, dim), 
        )
        self.train = False
    ...
    def __call__(self, variables):
        ...
        self.loss = F.mean_squared_error(y, variables[1])
        self.y = y
        return self.loss
    ...
    def forward(self, h, h1, printing = False):
        ...
        h = F.concat((h1,h))
        if printing: print('h1', h1.data.shape)
